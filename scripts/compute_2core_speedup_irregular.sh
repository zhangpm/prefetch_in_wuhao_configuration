...
do
    ...
    trace0=`sed -n ''$i'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/2core_irregular.txt | awk '{print $1}'`
    trace1=`sed -n ''$i'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/2core_irregular.txt | awk '{print $2}'`
