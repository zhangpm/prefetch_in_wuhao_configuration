...
do
    ...
    trace0=`sed -n ''$i'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/8core_irregular.txt | awk '{print $1}'`
    trace1=`sed -n ''$i'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/8core_irregular.txt | awk '{print $2}'`
    trace2=`sed -n ''$i'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/8core_irregular.txt | awk '{print $3}'`
    trace3=`sed -n ''$i'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/8core_irregular.txt | awk '{print $4}'`
    trace4=`sed -n ''$i'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/8core_irregular.txt | awk '{print $5}'`
    trace5=`sed -n ''$i'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/8core_irregular.txt | awk '{print $6}'`
    trace6=`sed -n ''$i'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/8core_irregular.txt | awk '{print $7}'`
    trace7=`sed -n ''$i'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/8core_irregular.txt | awk '{print $8}'`
