...
#      output_dir="/scratch/cluster/haowu/isb-meta/tisb-output-4core-irregular/$output/"
      output_dir="/scratch/cluster/haowu/isb-meta/triage-output-8core-irregular/$output/"
    ...
    #cd $output_dir
    command="/scratch/cluster/haowu/isb-meta/ChampSim_DPC3/scripts/run_8core_irregular.sh $binary 30 30 $num $output_dir"
